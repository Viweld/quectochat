...
import 'package:quectochat/data/repositories/home_repository.dart' as _i133;
...
import 'package:quectochat/domain/interfaces/i_home_repository.dart' as _i321;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.singleton<_i321.IHomeRepository>(
        () => _i133.HomeRepository(networkFacade: gh<_i547.INetworkFacade>()));
    gh.singleton<_i487.IAuthRepository>(
        () => _i706.AuthRepository(networkFacade: gh<_i547.INetworkFacade>()));
    gh.factoryParam<_i485.TypingViewBloc, String, dynamic>((
      interlocutorId,
      _,
    ) =>
        _i485.TypingViewBloc(
    ...
    gh.factory<_i676.HomeBloc>(() => _i676.HomeBloc(
          ...
          homeRepository: gh<_i321.IHomeRepository>(),
        ));
    return this;
  }
}
