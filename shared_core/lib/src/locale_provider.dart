...
class LocaleProvider extends StatefulWidget {
  ...
  static _LocaleProviderState? of(BuildContext context) {
    final _LocaleProviderInherited? inherited = context
        .dependOnInheritedWidgetOfExactType<_LocaleProviderInherited>();
...
class _LocaleProviderState extends State<LocaleProvider> {
  ...
  Widget build(BuildContext context) {
    return _LocaleProviderInherited(data: this, child: widget.child);
  }
}
...
class _LocaleProviderInherited extends InheritedWidget {
  const _LocaleProviderInherited({required this.data, required super.child});
