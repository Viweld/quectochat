...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.factory<_i672.SplashBloc>(() => _i672.SplashBloc(
          gh<_i842.SplashAuthenticationPort>(),
          gh<_i668.BlocErrorHandler>(),
        ));
    gh.factory<_i813.AuthGuard>(
        () => _i813.AuthGuard(gh<_i842.AuthenticationStatePort>()));
    gh.factory<_i311.GuestGuard>(
        () => _i311.GuestGuard(gh<_i842.AuthenticationStatePort>()));
    gh.lazySingleton<_i158.AuthStatusReevaluateListenable>(() => registerModule
        .authStatusReevaluateListenable(gh<_i842.AuthenticationStatePort>()));
