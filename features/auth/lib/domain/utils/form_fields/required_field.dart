...
enum RequiredFieldError { emptyField }
...
final class RequiredField extends FormField<String, RequiredFieldError> {
  const RequiredField({super.value = '', super.isErrorVisible});
  ...
  @override
  RequiredField copyWithVisibleError({required bool isErrorVisible}) =>
      RequiredField(value: super.value, isErrorVisible: isErrorVisible);
}
