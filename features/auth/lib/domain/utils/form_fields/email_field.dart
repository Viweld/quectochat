...
enum EmailFieldError { emptyField, wrongFormat }
...
final class EmailField extends FormField<String, EmailFieldError> {
  ...
  @override
  EmailField copyWithVisibleError({required bool isErrorVisible}) =>
      EmailField(value: super.value, isErrorVisible: isErrorVisible);
}
