...
import 'package:auth/presentation/create_invitation_screen/bloc/create_invitation_bloc.dart'
    as _i63;
import 'package:auth/presentation/invite_code_screen/bloc/invite_code_bloc.dart' as _i658;
...
class AuthPackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.factoryParam<_i63.CreateInvitationBloc, String, dynamic>(
      (targetRole, _) => _i63.CreateInvitationBloc(
        gh<_i698.AuthRepository>(),
        gh<_i668.BlocErrorHandler>(),
        targetRole: targetRole,
      ),
    );
    gh.factory<_i658.InviteCodeBloc>(
      () => _i658.InviteCodeBloc(gh<_i698.AuthRepository>(), gh<_i668.BlocErrorHandler>()),
    );
    ...
    gh.factoryParam<_i336.RegistrationBloc, String, dynamic>(
      (inviteCode, _) => _i336.RegistrationBloc(
        gh<_i698.AuthRepository>(),
        gh<_i668.BlocErrorHandler>(),
