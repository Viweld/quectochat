...
import 'package:auth/data/datasources/auth_remote_data_source_impl.dart'
    as _i512;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    gh.lazySingleton<_i906.AuthRemoteDataSource>(
        () => _i512.AuthRemoteDataSourceImpl());
    gh.lazySingleton<_i698.AuthRepository>(() => _i288.AuthRepositoryImpl(
        remoteDataSource: gh<_i906.AuthRemoteDataSource>()));
    gh.factoryParam<_i63.CreateInvitationBloc, String, dynamic>((
      targetRole,
      _,
    ) =>
        _i63.CreateInvitationBloc(
          gh<_i698.AuthRepository>(),
          gh<_i668.BlocErrorHandler>(),
          targetRole: targetRole,
        ));
    gh.factory<_i658.InviteCodeBloc>(() => _i658.InviteCodeBloc(
          gh<_i698.AuthRepository>(),
          gh<_i668.BlocErrorHandler>(),
        ));
    gh.factory<_i553.LoginBloc>(() => _i553.LoginBloc(
          gh<_i698.AuthRepository>(),
          gh<_i668.BlocErrorHandler>(),
        ));
    gh.factoryParam<_i336.RegistrationBloc, String, dynamic>((
      inviteCode,
      _,
    ) =>
        _i336.RegistrationBloc(
          gh<_i698.AuthRepository>(),
          gh<_i668.BlocErrorHandler>(),
