...
import 'package:chat/data/datasources/chat_remote_data_source_impl.dart' as _i524;
...
class ChatPackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    gh.lazySingleton<_i503.ChatRemoteDataSource>(() => _i524.ChatRemoteDataSourceImpl());
    gh.lazySingleton<_i250.ChatRepository>(
      () => _i166.ChatRepositoryImpl(
        remoteDataSource: gh<_i503.ChatRemoteDataSource>(),
        currentUserPort: gh<_i842.CurrentUserPort>(),
        chatNotificationClearPort: gh<_i842.ChatNotificationClearPort>(),
      ),
    );
