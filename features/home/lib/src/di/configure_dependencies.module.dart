...
import 'package:home/data/datasources/home_remote_data_source_impl.dart' as _i666;
...
import 'package:home/presentation/nested_contacts_screen/bloc/nested_contacts_bloc.dart' as _i200;
import 'package:home/presentation/nested_contacts_screen/nested_contacts_args.dart' as _i1023;
...
class HomePackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    gh.lazySingleton<_i987.HomeRemoteDataSource>(() => _i666.HomeRemoteDataSourceImpl());
    gh.lazySingleton<_i621.HomeRepository>(
      () => _i243.HomeRepositoryImpl(
        remoteDataSource: gh<_i987.HomeRemoteDataSource>(),
        currentUserPort: gh<_i842.CurrentUserPort>(),
      ),
    );
    gh.factory<_i200.HomeBloc>(
      () => _i200.HomeBloc(
    ...
    gh.factoryParam<_i200.NestedContactsBloc, _i1023.NestedContactsArgs, dynamic>(
      (args, _) => _i200.NestedContactsBloc(
        gh<_i621.HomeRepository>(),
        gh<_i668.BlocErrorHandler>(),
        args: args,
      ),
